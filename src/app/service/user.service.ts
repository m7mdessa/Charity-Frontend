...
export class UserService {
  ...
  updateUser(user: any): Observable<void> {
    return this.http.put<void>('https://localhost:7084/api/User/UpdateUser', user);
  }
  ...
  deleteCharityByUserId(id:number): Observable<any> {
    return this.http.delete('https://localhost:7084/api/User/deleteCharityByUserId/'+id);
  }
  ...
  uploadAttachment(file:FormData){
    this.http.post('https://localhost:7084/api/User/uploadImage' ,file).subscribe((resp:any)=>{
